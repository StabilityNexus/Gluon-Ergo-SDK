...
export class NodeService {
    ...
    async getWalletTxsByScanId(scanId: number, minInclusionHeight?: number, maxInclusionHeight?: number,
                               minConfirmations?: number, maxConfirmations?: number): Promise<any> {
    ...
    async getSpentBoxesByScanId(scanId: number, minInclusionHeight?: number, maxInclusionHeight?: number,
                                minConfirmations?: number, maxConfirmations?: number): Promise<any> {
        return this.getAuthorized(
    ...
    async getUnSpentBoxesByScanId(scanId: number, minInclusionHeight?: number, maxInclusionHeight?: number,
                                  minConfirmations?: number, maxConfirmations?: number): Promise<any> {
        return this.getAuthorized(
